...
export const DataProvider: FC<DataProviderProps> = ({ children }) => {
  ...
  const [ dairyEntries, setDairyEntries ] = useState<DairyModel[]>([]);
  ...
  return (
    <DataContext.Provider value={{ user, setUser, isInitialized, setInitialized, dairyEntries, setDairyEntries }}>
      {children}
